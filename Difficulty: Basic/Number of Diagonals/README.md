<h2><a href="https://www.geeksforgeeks.org/problems/number-of-diagonals1020/1?page=7&difficulty%5B%5D=-2&sortBy=">Number of Diagonals</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>, the task is to find the number of diagonals in N sided convex polygon.</span></p>
