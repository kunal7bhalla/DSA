<h2><a href="https://www.geeksforgeeks.org/problems/count-odd-factors0844/1?page=1&difficulty%5B%5D=0&company%5B%5D=Wipro&sortBy=">Count Odd Factors</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>N</strong>, count the numbers having<strong>&nbsp;an odd number of factors from 1 to N</strong> (inclusive).</span><br>
&nbsp;</p>
